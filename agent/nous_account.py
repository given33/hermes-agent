...
def nous_portal_billing_url(account_info: Optional[NousPortalAccountInfo] = None) -> str:
    ...
    try:
        from agent.provider_auth import DEFAULT_NOUS_PORTAL_URL
    except Exception:
...
def _fresh_account_info(
    *,
    ...
    try:
        from agent.provider_auth import get_provider_auth_state, resolve_nous_access_token
...
def _info_from_valid_jwt(
    ...
    *,
    ...
    try:
        from agent.provider_auth import _decode_jwt_claims
    except Exception:
        return None
