...
def init_agent(
    ...
    try:
        from agent.model_normalize import (
    ...
    agent._cache_ttl = "5m"
    try:
        from hermes_runtime.config import load_config as _load_pc_cfg
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        try:
            from hermes_runtime.config import load_config as _load_br_cfg
    ...
    try:
        from hermes_runtime.config import load_config as _load_sess_cfg
    ...
    try:
        from hermes_runtime.config import load_config as _load_agent_config
        ...
        try:
            ...
            if _mem_provider_name and _mem_provider_name.strip():
                ...
                if agent._memory_manager.providers:
                    ...
                    try:
                        from hermes_runtime.profile_identity import get_active_profile_name
