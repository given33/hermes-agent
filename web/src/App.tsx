...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden pt-[calc(3.5rem+env(safe-area-inset-top,0px))] lg:pt-0">        <div className="flex min-h-0 min-w-0 flex-1">
          <aside
            id="app-sidebar"
