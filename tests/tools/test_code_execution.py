...
class TestRpcTokenAuthorization(unittest.TestCase):
    ...
    def _drive_server(self, rpc_token, requests):
        """Run _rpc_server_loop against a real socketpair.
        ...
        # Default family (AF_INET loopback emulation): AF_UNIX does not exist
        # on Windows, and _rpc_server_loop only needs a connected pair.
