...
_IOS_NATIVE_ACTION_POLICY: dict[tuple[str, str], dict[str, Any]] = {
    ...
    ("ios-alarm", "schedule"): {"risk": "write", "confirmation": "required", "permission": "reminders"},
    ("ios-alarm", "list"): {"risk": "read", "confirmation": "none", "permission": "reminders"},
    ("ios-alarm", "cancel"): {"risk": "destructive", "confirmation": "required", "permission": "reminders"},
    ("ios-nlp", "analyze"): {"risk": "read", "confirmation": "none", "permission": None},
    ...
    ("ios-browser", "navigate"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "screenshot"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "get_text"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "get_readable"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "get_page_info"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "find_elements"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "get_backbone"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "list_tabs"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "get_cookies"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "wait_for_dom_stable"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "fetch"): {"risk": "read", "confirmation": "none", "permission": "network"},
    ("ios-browser", "click"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "type"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "scroll"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "hover"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "execute_js"): {"risk": "destructive", "confirmation": "required", "permission": "network"},
    ("ios-browser", "set_user_agent"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "set_viewport"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "new_tab"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "close_tab"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "set_cookies"): {"risk": "write", "confirmation": "required", "permission": "network"},
    ("ios-browser", "scroll_and_collect"): {"risk": "write", "confirmation": "required", "permission": "network"},
...
class QWeatherClient:
    ...
    def request(self, endpoint: str, params: Mapping[str, Any], *, cache_seconds: int = 300) -> dict[str, Any]:
        ...
        # A cache miss reserves the vendor request before any network I/O. This
        # makes the 30,000 cap a hard concurrency boundary and matches vendor
        # accounting: timeouts and error responses still consumed one request.
